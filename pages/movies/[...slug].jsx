...
export async function getServerSideProps(context) {
  ...
  const response = await fetch(
    `https://api.themoviedb.org/3/movie/${slug[0]}?api_key=${process.env.API_KEY}&language=en-GB&append_to_response=credits,recommendations,watch%2Fproviders,release_dates`
  );
